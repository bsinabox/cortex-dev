...
export function NotificationBanner() {
  ...
  // Confirmation banner — shown briefly after subscribing
  if (showConfirm) {
    return (
      <div className="mb-4 flex items-center gap-3 rounded-[10px] border border-emerald-200 bg-emerald-50 p-3 dark:border-emerald-800 dark:bg-emerald-950">
        ...
        <p className="min-w-0 flex-1 text-xs font-medium text-emerald-700 dark:text-emerald-300">
          Notifications enabled — you will get alerts for reviews, builds, and blockers.
        </p>
      </div>
    );
  }

  // Prompt banner — shown when permission not yet granted
  if (state === 'prompt' && !dismissed) {
    return (
